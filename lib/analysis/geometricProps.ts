 ...
 */
export class GeometricPropertiesCalculator implements GeometricCalculator {
...
export const calculateVolume = (state: StateVector): number => {
  return new GeometricPropertiesCalculator().calculateTotalVolume(state);
};

export const calculateArea = (graph: SimulationGraph): number => {
  return new GeometricPropertiesCalculator().calculateTotalArea(graph);
};

export const calculateEffectiveDimension = (graph: SimulationGraph, state: StateVector): number => {
  return new GeometricPropertiesCalculator().calculateEffectiveDimension(graph, state);
};

export const calculateVolumeEntropy = (state: StateVector): number => {
