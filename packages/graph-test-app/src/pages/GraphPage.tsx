    ...
    <AppLayout
      ...
      headerContent={
        <div className="flex items-center space-x-4">
          <a href="/" className="flex items-center space-x-2 px-3 py-2 rounded hover:bg-blue-600 bg-blue-500 text-white">
            <Activity className="w-4 h-4" />
            <span>Graph</span>
          </a>
          <a href="/quantum" className="flex items-center space-x-2 px-3 py-2 rounded hover:bg-blue-600 text-white">
