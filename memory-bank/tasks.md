...
|----|-------|--------|----------|---------|------|
| T55a | Implement Angular Momentum Algebra | 🔄 | HIGH | 2025-05-14 | [tasks/T55a.md] | Fixed operator construction and complex number handling, implementing remaining features |
