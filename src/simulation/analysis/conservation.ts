 ...
 */
export interface ConservationChecker {
  /**
 ...
 */
export class ProbabilityConservation implements ConservationChecker {
 ...
 */
export class TotalOccupancyConservation implements ConservationChecker {
  private tolerance: number;
 ...
 */
export class PositivityConservation implements ConservationChecker {
  private tolerance: number;
...
export class ConservationCheckerFactory {
   ...
   */
  static createStandardCheckers(tolerance: number = 1e-6): ConservationChecker[] {
    return [
